...
RcppExport SEXP _modelutil_Croots(SEXP xSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _modelutil_lenFind(SEXP TimeSEXP, SEXP InfectedSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_modelutil_Croots", (DL_FUNC) &_modelutil_Croots, 1},
    {"_modelutil_lenFind", (DL_FUNC) &_modelutil_lenFind, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_modelutil(DllInfo *dll) {
